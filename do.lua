...
if identifyexecutor then
    ...
    if execName:find("yub") or execName:find("yubx") then isYubX = true end
end
...
_E.makefolder = nil; _E.writefile = nil; _E.readfile = nil
_E.listfiles = nil; _E.isfile = nil; _E.isfolder = nil
...
local function LoadConfig()
    ...
    local success, data = pcall(function()
        if fsIsFile(ConfigFileName) then
            ...
            if jsonString and jsonString ~= "" then return HttpService:JSONDecode(jsonString) end
        end
        return nil
    end)
